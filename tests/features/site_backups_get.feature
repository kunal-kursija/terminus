Feature: List Backups for a Site
  ...
  Scenario: Get the URL of the latest DB backup
    ...
    Then I should get:
    """
    https://pantheon-backups.s3.amazonaws.com/1daeb04d-8eaf-4a06-90b7-04617605ef96/dev/1471562180_backup/behat-tests_dev_2016-08-18T23-16-20_UTC_code.tar.gz?Signature=INoN9zDlMfWa8A%2B%2BtxqdLhRI1Rs%3D&Expires=1471565930&AWSAccessKeyId=AKIAJEYKXMCPBZQYJYXQ
    """
